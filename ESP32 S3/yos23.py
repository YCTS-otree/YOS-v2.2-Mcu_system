...
# 初始化蓝牙UART对象
print('Initializing Bluetooth UART')
Bluetooth_uart = UART(2, baudrate=9600, rx=39,tx=40,timeout=10)
...
def mainloop(lcd):#================================================系统
    ...
    # 打印标题
    text = '                YOS on ESP32 S3\n'
    lcdp.print_text(text,False)
    lcd.show()

    shell_output('Welcome to YOS  [version:2.3]\nYCTS All rights reserved.\nMade By OCR\n')
